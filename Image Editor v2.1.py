...
class Window(QWidget):
    ...
    def ShowIMG(self):
        ...
        smol_org_img.save("Here add path for image(It's fast save of currently processed image)")
        pixmap = QPixmap("Here add path for image(It's fast save of currently processed image)")
    ...
    def ToGray(self):
        ...
        smol_gray_image.save("Here add path for image(It's fast save of currently processed image)")
        pixmap = QPixmap("Here add path for image(It's fast save of currently processed image)")
    ...
    def Contrast_Backend(self):
        ...
        smol_ctr_img.save("Here add path for image(It's fast save of currently processed image)")
        pixmap = QPixmap("Here add path for image(It's fast save of currently processed image)")
        self.smol_con_img.setPixmap(pixmap)
        self.bt_save.setEnabled(True)
        self.bt_con.setEnabled(True)
    ...
    def Rotator_Backend(self):
        ...
        smol_rot_img.save("Here add path for image(It's fast save of currently processed image)")
        pixmap = QPixmap("Here add path for image(It's fast save of currently processed image)")
        self.smol_con_img.setPixmap(pixmap)
        self.bt_save.setEnabled(True)
        self.bt_con.setEnabled(True)
    ...
    def Blur_Backend(self):
        ...
        smol_blr_img.save("Here add path for image(It's fast save of currently processed image)")
        pixmap = QPixmap("Here add path for image(It's fast save of currently processed image)")
        self.smol_con_img.setPixmap(pixmap)
        self.bt_save.setEnabled(True)
        self.bt_con.setEnabled(True)
    ...
    def Flip_Sides(self):
        ...
        smol_flip_img.save("Here add path for image(It's fast save of currently processed image)")
        pixmap = QPixmap("Here add path for image(It's fast save of currently processed image)")
        self.smol_con_img.setPixmap(pixmap)
        self.bt_save.setEnabled(True)
        self.bt_con.setEnabled(True)
